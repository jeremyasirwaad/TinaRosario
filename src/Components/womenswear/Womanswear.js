...
export const Womanswear = () => {
  ...
  const getdata = async () => {
    const data = await fetch("http://products.tinarosario.com/api/Products?filters[Main_Category][$eq]=Women's Wear")
      .then((res) => res.json())
      .then((result) => {
    ...
    <div className="designercollections">
      ...
      <div className="prodpage">
        ...
        >
          ...
          <span  style={{ marginTop: "10px" }} className="prodpaget2">"Specially designed to enhance your style"</span>
        </div>
