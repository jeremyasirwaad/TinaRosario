...
export const Handloom = () => {
	...
	const getdata = async () => {
		const data = await fetch(
			"https://tinarosario.com/api/Products?filters[Main_Category][$eq]=Ethnic Wear"
		)
			.then((res) => res.json())
			.then((result) => {
		...
		<div className="designercollections">
			...
			<div className="prodpage">
				...
				>
					...
					<span className="prodpaget1">Ethnic Wear</span>
					<span style={{ marginTop: "10px" }} className="prodpaget2">
						“Blending culture and fashion together”
					</span>
				</div>
