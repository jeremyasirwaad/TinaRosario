		...
		<div className="footercontainer">
			<div className="footerinnercontainer">
				...
				<div className="column faq">
					<p>FAQ's</p>
					<h4 onClick={() => navigate("/faq_reg", { state: 1 })}>
						Working Model{" "}
					</h4>
					<h4 onClick={() => navigate("/faq_reg", { state: 2 })}>
						Pricing & Payment{" "}
					</h4>
					<h4 onClick={() => navigate("/faq_order", { state: 3 })}>
						Order & Customization
					</h4>
					<h4 onClick={() => navigate("/faq_deli", { state: 4 })}>
						Delivery, Return & Refund
					</h4>
					<h4 onClick={() => navigate("/faq_ship", { state: 5 })}>
						Shipping & Tracking
					</h4>
				</div>
				<div className="column links">
					...
					<div className="footer-links">
						<a href="https://www.facebook.com/people/Tina-Rosario-The-Design-House/100086487516274/">
							<img
								className="foot-link-logo"
								src="https://img.icons8.com/cotton/2x/facebook.png"
							/>
						</a>
