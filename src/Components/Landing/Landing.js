      ...
      <div className="landbgdiv">
        ...
        <div className="servcaro">
          ...
          <img
            id="exclusive"
            src={
              "https://firebasestorage.googleapis.com/v0/b/teenz-fe41d.appspot.com/o/Group%20668.png?alt=media&token=e6ede0e5-af4f-453d-b1ef-947156f55381"
            }
            alt=""
            onClick={() => navigate("/Handloom")}
            style={{ cursor: "pointer" }}
        ...
        <span className="Landingtesti" id="Landingtesti" style={{ fontSize: "40px" }}>
          Testimonials
        </span>
