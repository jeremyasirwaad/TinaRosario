    ...
    >
      ...
      <div className="landbgdiv">
        ...
        <div className="landiconsdiv">
          ...
          >
            <svg width="70" height="70" viewBox="0 0 84 80" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="carousel-inner">
                <div class="carousel-item caroresfix active ">
                  <div>
                    ...
                    <div>
                      <span style={{ fontSize: "20px", color: "#FFB8BC" }}>{pagedata[0].attributes.Text}</span>
                      <p style={{ textAlign: "right", fontSize: "18px" }}>{pagedata[0].attributes.name}</p>
                    </div>
                  </div>
                </div>
                  ...
                  return (
                    <div class="carousel-item caroresfix  ">
                      <div>
                        ...
                        <div>
                          <span style={{ fontSize: "20px", color: "#FFB8BC" }}>{e.attributes.Text}</span>
                          <p style={{ textAlign: "right", fontSize: "18px" }}>{e.attributes.name}</p>
                        </div>
                      </div>
                    </div>
                  );
