				...
				<div className="textcontainer">
					<ul>
						<li style={{ textAlign: "left" }}>
							Did you ever know that textile production contributes to around
							20% of the world's water pollution?
						</li>
						<li style={{ textAlign: "left" }}>
							Do you feel inclined to play a small meaningful part?
						</li>
					</ul>
					...
					<p style={{ textAlign: "left" }}>
						...
						they cause little harm to our mother planet. They are versatile,
				...
				<div className="imgfabrows">
					<div className="imgfabrow1">
						...
						<div className="imgfabrowinner">
							...
							<p>
								...
								abilities. Cotton is an incredibly suitable choice for summer
								dresses. It comes in various forms - Kaftans, frocks, timeless
								kurtas, simple shirts and the list goes on. An easy to care
								product, it provides a premium feel at attractive prices. People
					...
					<div className="imgfabrow2">
						...
						<div className="imgfabrowinner">
							...
							<p>
								Jute is easy to work with fabric. Extremely affordable, they do
								not need fertilizers or pesticides to grow. Their high tenacity
								enables rough use. It is usually blended with other fabrics such
								as rayon or nylon for a soft & shiny feel. One could start
								styling hats, wraps, throws and sweaters. Well-knit jute
								cardigans and cowls provide a special grace. It comes with a
								lifelong hand wash warranty!
							</p>
						</div>
					</div>
					<div className="imgfabrow1">
						...
						<div className="imgfabrowinner">
							...
							<p>
								...
								Considered an all season fabric, keeps you warm in winter and
					...
					<div className="imgfabrow2">
						...
						<div className="imgfabrowinner">
							...
							<p>
								...
								They have a lower thread count and are less-likely to trap dust
								particles from the environment. The inherent white color
								reflects heat-inducing solar rays. Considered luxury, it gets
								softer after each wash and can last up to 30 years. An extensive
								array lines up - blazers, jackets, formal pants and blouses,
								trendy jumpsuits, and other designer silhouettes.They dry
								quickly and a simple wash gives back the fresh look. It’s often
								referred to as the ROYAL LINEN!
							</p>
						</div>
					</div>
				</div>
					...
					<div className="imgfabrow2">
						...
						<div className="imgfabrowinner">
							...
							<p>
								...
								cotton and silk in a complex traditional manner. Its unique
								vertical symmetry and geometric motifs lend to many natural
								patterns - chevron, diamond, stripes & checks. Many parts of
								India have their indigenous ikat weaving techniques. Orissa’s
								Sambalpuri Ikat is quite different from the sharp ikat patterns
								woven in Patan of Gujarat. The latter, known as Patan Patola, is
								one of the rarest forms of double Ikat, which takes a lot of
								time and effort in dyeing and weaving. A different form of
								Patola ikat is made in Rajkot, Gujarat. Telia Rumal made in
								Andhra, Pasapalli from Odisha, and Puttapaka from Telangana are
								other Indian Ikats. It is colored using natural dyes. Easy to
								maintain, they make good choices for trendy maxi skirts, fancy
								jumpsuits, or timeless blouses.
							</p>
						</div>
					</div>
					<div className="imgfabrow1">
						...
						<div className="imgfabrowinner">
							...
							<p>
								...
								however it is believed to have originated in the modern-day
								...
								detailing. Silk and cotton are the often used fabrics. These
								clothes contain a special odor in them, as the complete process
								involves the usage of buffalo milk. Generally, used in the form
								of elegant sarees, they can also be designed into tops or
								kurtas. Kalamkari Dupattas have been a recent trend for its
