      ...
      <div className="weddingbg">
        <div className="icons">
          <div className="icon-holder">
            <img src={img1} />
            <p>Confused what looks good on you?</p>
          </div>
          <div className="icon-holder">
            <img src={img2} />
            <p>Unsure which dress suits your personality?</p>
          </div>
          <div className="icon-holder">
            <img src={img3} />
            <p>Trouble identifying the right color choices?</p>
          </div>
        </div>
        ...
        <div style={{}} className="weddingforms imageform">
          ...
          <button style={{ marginBottom: "20px" }} className="weddingbookbtn">
            Book
          </button>
        </div>
      </div>
