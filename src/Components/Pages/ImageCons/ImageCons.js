      ...
      <div className="Iweddingbg">
        <div className="icons">
          <div className="icon-holder">
            <img src={img1} />
            <span style={{ fontSize: "20px" }}>Confused what looks good on you?</span>
          </div>
          <div className="icon-holder">
            <img src={img2} />
            <span style={{ fontSize: "20px" }}>Unsure which dress suits your personality?</span>
          </div>
          <div className="icon-holder">
            <img src={img3} />
            <span style={{ fontSize: "20px" }}>Trouble identifying the right color choices?</span>
          </div>
        </div>
        <div className="img-row">
          ...
          <p style={{ fontSize: "20px" }}>
            ...
            <br style={{ fontSize: "20px" }} /> will guide you to make a fashion statement and
            <br style={{ fontSize: "20px" }} /> enhance your personal, professional and social image.
          </p>
        </div>

        <div className="steps1">
          <img style={{ marginTop: "80px", marginBottom: "20px" }} src={steps} />
        </div>
        <div className="steps">
          <img src={smilebar} />
        </div>
