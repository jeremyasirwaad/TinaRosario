		...
		<div className="policontainer">
			<div className="pheader">
				...
				<p style={{ color: "#270641" }}>
					...
					you, whether personally or on behalf of an entity ("you") and TINA
					ROSARIO THE DESIGN HOUSE ("Company," "we," "us," or "our"), concerning
					your access to and use of the http://www.tinarosario.com website as
					...
					registered office at 112A Nehru Street, Alwar Thiru Nagar,
					Valasarawakkam, Chennai, Tamilnadu 600087. You agree that by accessing
					...
					<br /> The information provided on the Site is not intended for
					...
					<br /> The Site is intended for users who are at least 13 years of
			...
			<Accordion style={inneraccordionStyle1}>
				...
				<AccordionDetails style={accordionDetail}>
					<Typography sx={{ fontSize: "18px" }}>
						We, at “The Design House”, consider our customer’s privacy with
						utmost importance. Hence, we maintain higher standards in designing
						our features to maintain all data of our customers with high
						confidentiality. We ensure that we would be collecting only the
						details necessary for our dealings with you. In fact, you have
						complete freedom to visit the site and browse without having to
						provide any personal details, however, please note that the
						submission of your details is recommended when you wish to do
						shopping with us. <br />
						By visiting our platform and providing your details, it implies that
						you expressly agree to stay bound to our terms and policies.
						<br />
						The above privacy policy is applicable only to the visitors of our
						site and their online activities, with regards to the details that
						you have shared to us. These policies do not comply with any
						information shared or collected via channels other than this website
						or offline mode.
					</Typography>
				</AccordionDetails>
			</Accordion>
			...
			<Accordion style={inneraccordionStyle1}>
				...
				<AccordionDetails style={accordionDetail}>
					<Typography sx={{ fontSize: "18px" }}>
						Unless otherwise indicated, the Site is our proprietary asset and
						...
						competition laws of the India. The Content and the Marks are
					...
					<Typography sx={{ fontSize: "18px" }}>
						...
						<ul>
							...
							<li>
								...
								graphics interchange formats ("gifs"), 1 xl pixels, web bugs,
							...
							<li>
								...
								Flash, PHR HTML, JavaScript, or other code.
							</li>
							<li>
			...
			<Accordion style={inneraccordionStyle1}>
				...
				<AccordionDetails style={accordionDetail}>
					<Typography sx={{ fontSize: "18px" }}>
						...
						and nonproprietary. When you create or make available any
			...
			<Accordion style={inneraccordionStyle1}>
				...
				<AccordionDetails style={accordionDetail}>
					<Typography sx={{ fontSize: "18px" }}>
						...
						India. TINA ROSARIO THE DESIGN HOUSE and yourself irrevocably
			...
			<Accordion style={inneraccordionStyle1}>
				...
				<AccordionDetails style={accordionDetail}>
					<Typography sx={{ fontSize: "18px" }}>
						...
						<br /> Any dispute arising out of or in connection with this
						contract, including any question regarding its existence, validity,
						or termination, shall be referred to and finally resolved through
						the governing laws of India. The seat, or legal place, of
						arbitration shall be Chennai, India. The language of the proceedings
						shall be English. The governing law of the contract shall be the
						substantive law of India.
						<br />
						<b>Restrictions</b>
						<br /> The Parties agree that any arbitration Shall be limited to
						the Dispute between the Parties individually, to the full extent
						permitted by law, (a) arbitration Shall be joined with any other
						...
						<br /> The Parties agree that the following Disputes are not subject
			...
			<Accordion style={inneraccordionStyle1}>
				...
				<AccordionDetails style={accordionDetail}>
					<Typography sx={{ fontSize: "18px" }}>
						...
						LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH THE SITE BY ANY THIRD
			...
			<Accordion style={inneraccordionStyle1}>
				...
				<AccordionDetails style={accordionDetail}>
					<Typography sx={{ fontSize: "18px" }}>
						...
						of signing by the parties here to execute these Terms.
					</Typography>
				</AccordionDetails>
			</Accordion>
