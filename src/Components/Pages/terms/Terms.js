      ...
      <Accordion expanded={expand22} style={inneraccordionStyle1}>
        ...
        <AccordionDetails style={accordionDetail}>
          <Typography sx={{ fontSize: "18px" }}>
            ...
            may have based on the electronic form of these Terms of Use and the lack of signing by the parties here to
            execute these Terms.
          </Typography>
        </AccordionDetails>
      </Accordion>
      ...
      <Accordion expanded={expand23} style={inneraccordionStyle1}>
        ...
        >
          <img
            ...
            src={contact}
          />
          <Typography sx={{ alignSelf: "center", fontWeight: "bold", fontSize: "22px" }}>XXIII. CONTACT US</Typography>
        </AccordionSummary>
        <AccordionDetails style={accordionDetail}>
          <Typography sx={{ fontSize: "18px" }}>
