      ...
      {loading == false && loading2 == false ? (
        <div>
          <div className="responsiveTitle">
            <span className="productname1">{pagedata.attributes.Product_name}</span>
            {state.countryName == "India" ? (
              <span className="productprice1">INR {pagedata.attributes.price}</span>
            ) : (
          ...
          <div className="productspages">
            <div className="prodpagegalsection">
              ...
              <div style={{ display: "flex", flexDirection: "column" }}>
                {showimg1 && <img className="mainimg" src={pagedata.attributes.Img_1} alt="" />}

                {showimg2 && <img className="mainimg" src={pagedata.attributes.Img_2} alt="" />}

                {showimg3 && <img className="mainimg" src={pagedata.attributes.Img_3} alt="" />}
                <span
                  style={{
                    marginTop: "10px",
                    display: "flex",
                ...
                >
                  {" "}
                  <span style={{ fontSize: "12px" }}># </span> Image color may vary
                </span>
              </div>
            </div>
            <div className="prodpagedatasection">
              <span className="productname">{pagedata.attributes.Product_name}</span>
              {state.countryName == "India" ? (
                <span className="productprice">INR {pagedata.attributes.price}</span>
              ) : (
                <span className="productprice">USD {pagedata.attributes.priceinUSD}</span>
              )}

              <span className="productdescriptiontitle">Product Description</span>
              <span className="productdescription">{pagedata.attributes.description}</span>
              <div
                style={{
                  display: "flex",
                  width: "350px",
              ...
              >
                <div className="washcarediv">
                  <img className="washcareimg" src={fabricsicon} alt="" style={{ marginRight: "10px" }} />
              ...
              >
                <div className="washcarediv" style={{ width: "115px" }}>
                  ...
                  />
                  <span className="washcare">{pagedata.attributes.Wash_Care}</span>
                </div>
              </div>
              <div
                style={{
                ...
                className="resclass"
              >
                <div className="washcarediv" style={{ width: "150px", marginTop: "25px" }}>
                  <img className="washcareimg" src={delivery} alt="" style={{ width: "25px", height: "auto" }} />
              ...
              <span className="producttabs">
                {pagedata.attributes.Main_Category} | {pagedata.attributes.Sub_Category} | {pagedata.attributes.Color}
              </span>
              <button
