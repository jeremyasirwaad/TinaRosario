...
export const Policies = () => {
  ...
  const inneraccordionStyle2 = {
    borderRadius: "20px",
    backgroundColor: expand2 ? "#4C2A76" : "transparent",
    color: expand2 ? "#FFB8BC" : "#4C2A76",
    marginBottom: "20px",
    "&:before": {
      display: "none",
      border: "none",
  ...
  const inneraccordionStyle3 = {
    borderRadius: "20px",
    backgroundColor: expand3 ? "#4C2A76" : "transparent",
    color: expand3 ? "#FFB8BC" : "#4C2A76",
    marginBottom: "20px",
    "&:before": {
      display: "none",
      border: "none",
  ...
  const inneraccordionStyle4 = {
    borderRadius: "20px",
    backgroundColor: expand4 ? "#4C2A76" : "transparent",
    color: expand4 ? "#FFB8BC" : "#4C2A76",
    marginBottom: "20px",
    "&:before": {
      display: "none",
      border: "none",
  ...
  const inneraccordionStyle5 = {
    borderRadius: "20px",
    backgroundColor: expand5 ? "#4C2A76" : "transparent",
    color: expand5 ? "#FFB8BC" : "#4C2A76",
    marginBottom: "20px",
    "&:before": {
      display: "none",
      border: "none",
  ...
  const inneraccordionStyle6 = {
    borderRadius: "20px",
    backgroundColor: expand6 ? "#4C2A76" : "transparent",
    color: expand6 ? "#FFB8BC" : "#4C2A76",
    marginBottom: "20px",
    "&:before": {
      display: "none",
      border: "none",
  ...
  const inneraccordionStyle7 = {
    borderRadius: "20px",
    backgroundColor: expand7 ? "#4C2A76" : "transparent",
    color: expand7 ? "#FFB8BC" : "#4C2A76",
    marginBottom: "20px",
    "&:before": {
      display: "none",
      border: "none",
  ...
  const inneraccordionStyle8 = {
    borderRadius: "20px",
    backgroundColor: expand8 ? "#4C2A76" : "transparent",
    color: expand8 ? "#FFB8BC" : "#4C2A76",
    marginBottom: "20px",
    "&:before": {
      display: "none",
      border: "none",
  ...
  const inneraccordionStyle9 = {
    borderRadius: "20px",
    backgroundColor: expand9 ? "#4C2A76" : "transparent",
    color: expand9 ? "#FFB8BC" : "#4C2A76",
    marginBottom: "20px",
    "&:before": {
      display: "none",
      border: "none",
