...
export const Weddingcollections = () => {
  ...
  const getdata = async () => {
    const data = await fetch("https://tinarosario.com/api/Products?filters[Main_Category][$eq]=Wedding Collection")
      .then((res) => res.json())
      .then((result) => {
        const data = result.data;
        // const data = temp.filter(
        // 	(e) => e.attributes.Main_Category == "Wedding Collection"
        // );
        setPagedata(data);
  ...
  useEffect(() => {
    ...
    if (state.countryName == "India") {
      if (pricefilter != 0) {
        ...
        if (pricefilter == 2) {
          const data = backupagedata.filter((e) => {
            return parseInt(e.attributes.price) > 5000 && parseInt(e.attributes.price) <= 10000;
          });
    ...
    <div className="designercollections">
          ...
          <div className="subinner">
            ...
            <div className={subcatoptions ? "fliterchoicediv displaynone" : "fliterchoicediv"}>
              <div className="fliterchoice" style={{ marginTop: "10px" }}>
                ...
                />
                <span style={{ marginLeft: "10px", marginTop: "2px" }}>Men</span>
              </div>
              <div className="fliterchoice">
                ...
                />
                <span style={{ marginLeft: "10px", marginTop: "2px" }}>Women</span>
              </div>
              <div className="fliterchoice">
                <input
                  type="checkbox"
                ...
                />
                <span style={{ marginLeft: "10px", marginTop: "2px" }}>Kids'</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="subinner">
              ...
              <div className={subpriceoptions ? "fliterchoicediv displaynone" : "fliterchoicediv"}>
                ...
                <div className="fliterchoice">
                  ...
                  />
                  <span style={{ marginLeft: "10px", marginTop: "2px" }}>more than 10000</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="prodpage">
        ...
        >
          ...
          <span className="prodpaget1">Wedding Collection </span>
          <span style={{ marginTop: "0px" }} className="prodpaget2">
            “Look Special”
          </span>
        </div>
