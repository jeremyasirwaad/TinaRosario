...
export const DesignerCollections = () => {
  ...
  const getdata = async () => {
    const data = await fetch("http://products.tinarosario.com/api/Products")
      ...
      .then((result) => {
        ...
        const data = temp.filter((e) => e.attributes.Main_Category == "Designer Wear");
        setPagedata(data);
  ...
  useEffect(() => {
    ...
    if (pricefilter != 0) {
      ...
      if (pricefilter == 3) {
        const data = pagedata.filter((e) => {
          return parseInt(e.attributes.price) > 10000 && parseInt(e.attributes.price) < 15000;
        });
      ...
      if (pricefilter == 4) {
        const data = pagedata.filter((e) => {
          return parseInt(e.attributes.price) > 15000 && parseInt(e.attributes.price) < 20000;
        });
          ...
          <div className="subinner">
            ...
            <div className={subcatoptions ? "fliterchoicediv displaynone" : "fliterchoicediv"}>
              ...
              <div className="fliterchoice">
                ...
                />
                <span style={{ marginLeft: "10px", marginTop: "2px" }}>Kid's</span>
              </div>
            </div>
          </div>
        </div>
