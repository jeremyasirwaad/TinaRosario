...
export const Kidswear = () => {
  ...
  const getdata = async () => {
    const data = await fetch("http://products.tinarosario.com/api/Products?filters[Main_Category][$eq]=Kids' Wear")
      .then((res) => res.json())
      .then((result) => {
    ...
    <div className="designercollections">
      ...
      <div className="prodpage">
        ...
        >
          ...
          <span className="prodpaget1">Kids Wear</span>
          <span  style={{ marginTop: "10px" }} className="prodpaget2">"Specially made for the little muffins"</span>
        </div>
