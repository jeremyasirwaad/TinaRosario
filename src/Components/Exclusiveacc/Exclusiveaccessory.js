  ...
  useEffect(() => {
    ...
    if (state.countryName == "India") {
      if (pricefilter != 0) {
        ...
        if (pricefilter == 2) {
          const data = backupagedata.filter((e) => {
            return parseInt(e.attributes.price) > 2000 && parseInt(e.attributes.price) <= 4000;
          });
        ...
        if (pricefilter == 3) {
          const data = backupagedata.filter((e) => {
            return parseInt(e.attributes.price) > 4000 && parseInt(e.attributes.price) <= 6000;
          });
      ...
      if (pricefilter != 0) {
        ...
        if (pricefilter == 2) {
          const data = backupagedata.filter((e) => {
            return parseInt(e.attributes.priceinUSD) > 50 && parseInt(e.attributes.priceinUSD) <= 100;
          });
        ...
        if (pricefilter == 3) {
          const data = backupagedata.filter((e) => {
            return parseInt(e.attributes.priceinUSD) > 100 && parseInt(e.attributes.priceinUSD) <= 150;
          });
        ...
        if (pricefilter == 4) {
          const data = backupagedata.filter((e) => {
            return parseInt(e.attributes.priceinUSD) > 150 && parseInt(e.attributes.priceinUSD) <= 200;
          });
          ...
          <div className="subinner">
            ...
            <div className={subcatoptions ? "fliterchoicediv displaynone" : "fliterchoicediv"}>
              <div className="fliterchoice" style={{ marginTop: "10px" }}>
                ...
                />
                <span style={{ marginLeft: "10px", marginTop: "2px" }}>Jewellery</span>
              </div>
              <div className="fliterchoice">
                ...
                />
                <span style={{ marginLeft: "10px", marginTop: "2px" }}>Designer Belt</span>
              </div>
              <div className="fliterchoice">
                <input
                  type="checkbox"
                ...
                />
                <span style={{ marginLeft: "10px", marginTop: "2px" }}>Footwear</span>
              </div>
              <div className="fliterchoice">
                <input
                  type="checkbox"
                ...
                />
                <span style={{ marginLeft: "10px", marginTop: "2px" }}>Hat</span>
              </div>
              <div className="fliterchoice">
                <input
                  type="checkbox"
                ...
                />
                <span style={{ marginLeft: "10px", marginTop: "2px" }}>Hair Accessories</span>
              </div>
              <div className="fliterchoice">
                <input
                  type="checkbox"
                ...
                />
                <span style={{ marginLeft: "10px", marginTop: "2px" }}>Wedding Accessories</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="subinner">
              ...
              <div className={subpriceoptions ? "fliterchoicediv displaynone" : "fliterchoicediv"}>
                <div className="fliterchoice" style={{ marginTop: "10px" }}>
                  ...
                  />
                  <span style={{ marginLeft: "10px", marginTop: "2px" }}>Less than 2000</span>
                </div>
                <div className="fliterchoice">
                  <input
                    type="checkbox"
                  ...
                  />
                  <span style={{ marginLeft: "10px", marginTop: "2px" }}>2001 - 4000</span>
                </div>
                <div className="fliterchoice">
                  <input
                    type="checkbox"
                  ...
                  />
                  <span style={{ marginLeft: "10px", marginTop: "2px" }}>4000 - 6000</span>
                </div>
                <div className="fliterchoice">
                  <input
                    type="checkbox"
                  ...
                  />
                  <span style={{ marginLeft: "10px", marginTop: "2px" }}>More than 6000</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="subinner">
              ...
              <div className={subpriceoptions ? "fliterchoicediv displaynone" : "fliterchoicediv"}>
                <div className="fliterchoice" style={{ marginTop: "10px" }}>
                  ...
                  />
                  <span style={{ marginLeft: "10px", marginTop: "2px" }}>Less than 50</span>
                </div>
                <div className="fliterchoice">
                  <input
                    type="checkbox"
                  ...
                  />
                  <span style={{ marginLeft: "10px", marginTop: "2px" }}>51 - 100</span>
                </div>
                <div className="fliterchoice">
                  <input
                    type="checkbox"
                  ...
                  />
                  <span style={{ marginLeft: "10px", marginTop: "2px" }}>101 - 150</span>
                </div>
                <div className="fliterchoice">
                  <input
                    type="checkbox"
                  ...
                  />
                  <span style={{ marginLeft: "10px", marginTop: "2px" }}>151-200</span>
                </div>
                <div className="fliterchoice">
                  <input
                    type="checkbox"
                  ...
                  />
                  <span style={{ marginLeft: "10px", marginTop: "2px" }}>More than 200</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="subinner">
            ...
            <div className={subcolor ? "fliterchoicediv displaynone" : "fliterchoicediv"}>
              ...
              <div className="fliterchoice">
                ...
                />
                <span style={{ marginLeft: "10px", marginTop: "2px" }}>Shades of Black</span>
              </div>
              <div className="fliterchoice">
                <input
                  type="checkbox"
                ...
                />
                <span style={{ marginLeft: "10px", marginTop: "2px" }}>Shades of White</span>
              </div>
            </div>
          </div>
        </div>
