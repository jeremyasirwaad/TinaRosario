...
export const Exclusiveaccessory = () => {
	...
	const getdata = async () => {
		const data = await fetch(
			"https://tinarosario.com/api/Products?filters[Main_Category][$eq]=Twinning Collection"
		)
			.then((res) => res.json())
			.then((result) => {
		...
		<div className="designercollections">
			...
			<div className="prodpage">
				...
				>
					...
					<span className="prodpaget1">Twinning Collections</span>
					<span style={{ marginTop: "10px" }} className="prodpaget2">
						"Identical styles create magic"
					</span>
				</div>
